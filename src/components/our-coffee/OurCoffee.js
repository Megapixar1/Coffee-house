...
import CupCoffee from '../../resources/img/ourCoffee/cup-coffe2.jpg';
...
const OurCoffee = () => {
    ...
    // Dynamically building bottuns and adding an activity class.
    const buttonsData = [
    ...
    const buttons = buttonsData.map(({name, country}) => {
        const active = {filter}.filter === country;
        const clas  = active ? 'btn-active' : '';

        return (
            <button 
            className={`btn-filter ${clas}`}
            type='button'
            key={name}
        ...
        <>
            <div className="container">
                <div className="for-your-coffee">
                    <h1 className='for-your-coffee__title'>Our Coffee</h1>
                </div>
                ...
                <div className="about-our__right">
                    <h5 className='our__right-title'>About our beans</h5>
                    <CoffeeLogo /> 
             ...
             <div className="block-search">
                    <div className="block-search__left">
                        <h4 className='search__left-title'>Lookiing for</h4>
                        <input value={term} onChange={onUpdateSearch} type="text" placeholder='start typing here...' />
                    </div>
                    <div className="block-search__right">
                        <h4 className='search__right-title'>Or filter</h4>
                        {buttons}
                    </div>
            </div>           
...
export default transition(OurCoffee);
